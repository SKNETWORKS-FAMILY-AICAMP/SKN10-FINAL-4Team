...
for sentence in sentences:
    ...
    try:
        ...
        headers = {
            "x-sup-api-key": SUPERTONES_API_KEY,
...
print("\nAll audio files have been generated and saved in the 'Supertones' directory.")